...
export const metadata: Metadata = {
  title: "ShortcutX - Advanced Parser Tools",
  description: "Platform terpadu untuk parsing dan analisis data mutasi BCA, AutoWD, dan Admin Power dengan presisi tinggi.",
  keywords: ["Parser", "BCA", "Mutasi", "AutoWD", "Admin Power", "Tools", "ShortcutX"],
